          ...
          <div className="main-header has-billboard menu-navigation" role="navigation">
            ...
            <ul className="tabbed-primary-navigation">
              <li className="navigation-menu">
                <a className="menu-trigger" role="button" aria-haspopup="true" href="todo" tabindex="0">Explorar</a>
              </li>
              <li className="navigation-tab">
                <a className="current active" href="/browse">Inicio</a>
              </li>
              <li className="navigation-tab">
            ...
            <div className="secondary-navigation">
              <div className="nav-element">
                <div className="searchBox">
                  <button className="searchTab" tabindex="0" aria-label="Buscar" data-uia="search-box-launcher">
              ...
              <div className="nav-element">
                <span className="notifications">
                  <button className="notifications-menu" aria-haspopup="true" aria-expanded="false" aria-label="Notificaciones">
                  ...
                  <div className="account-dropdown-button">
                    <a href="/YourAccount" role="button" tabindex="0" aria-haspopup="true" aria-expanded="false" aria-label="Maria Jose - Cuenta y configuración">
                      <span className="profile-link" role="presentation">
                        <img className="profile-icon" src="http://occ-0-7118-114.1.nflxso.net/dnm/api/v6/K6hjPJd6cR6FpVELC5Pd6ovHRSk/AAAABeD-D1z0XBTshF8RleitH-BbW2-bfi_8NTuyMJPGSD-db9NLp-goDTQHTmoPI-qCCB5Y9yjqHmnwAj1QwDPPZOtV5AiDxkw.png?r=d0a" alt=""/>
                      </span>
                    </a>
